...
void read_png(char *file, char *file2)
{
    ...
    */
    ...
    /*
    ====================================================
            Read image, get row pointers with RGB data
    ====================================================
    */
    ...
    deconstructor(0, height, width, 0);
    ...
    */
    ...
    reconstructor(0, height, width, 0);

    /*
    ===================================================
            Create output file and write filtered image
    ===================================================
    */    
...
Image Median Filter
How it works:
Separates all RGB values in different arrays (one per color).
Then it finds the median values for each pixel and its neighbors.
Then depending if the number is even or odd it will use the 
median of each array or find the median through the 
sum of the values at the middle index of the arrays.
NOTE: This filter is based on a rosetta stone code for PPM images.
===================================================
*/
...
int main(int argc, char *argv[])
{
    ...
    printf("Execution time without OMP: %f\n", cpu_time_used);
    return 0;
}
//Comparison function used by the quick-sort to rearrange values to get median
int cmpfunc(const void *a, const void *b)
{
    return (*(int *)a - *(int *)b);
}